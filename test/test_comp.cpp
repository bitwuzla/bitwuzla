...
{
  u_comp_test(lt, boolector_ult, BZLA_TEST_COMP_LOW, BZLA_TEST_COMP_HIGH, 1);
  u_comp_test(lt, boolector_ult, BZLA_TEST_COMP_LOW, BZLA_TEST_COMP_HIGH, 0);
}

TEST_F(TestComp, test_ulte)
{
  u_comp_test(lte, boolector_ulte, BZLA_TEST_COMP_LOW, BZLA_TEST_COMP_HIGH, 1);
  u_comp_test(lte, boolector_ulte, BZLA_TEST_COMP_LOW, BZLA_TEST_COMP_HIGH, 0);
}
...
{
  s_comp_test(lte, boolector_slte, BZLA_TEST_COMP_LOW, BZLA_TEST_COMP_HIGH, 1);
  s_comp_test(lte, boolector_slte, BZLA_TEST_COMP_LOW, BZLA_TEST_COMP_HIGH, 0);
}

TEST_F(TestComp, test_sgt)
{
  s_comp_test(gt, boolector_sgt, BZLA_TEST_COMP_LOW, BZLA_TEST_COMP_HIGH, 1);
  s_comp_test(gt, boolector_sgt, BZLA_TEST_COMP_LOW, BZLA_TEST_COMP_HIGH, 0);
}
