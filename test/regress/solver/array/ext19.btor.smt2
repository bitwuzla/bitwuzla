...
(assert (= #b1 (bvand (bvand (bvand (ite (= v0 v2) #b1 #b0) (ite (= v1 v3) #b1 #b0)) (ite (= (select a0 (bvnot v0)) (select a1 (bvnot v0))) #b1 #b0)) (bvnot (ite (= (store a0 v0 v1) (store a1 v2 v3)) #b1 #b0)))))
(check-sat)
