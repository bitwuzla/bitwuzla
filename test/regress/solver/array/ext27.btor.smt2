...
(assert (= #b1 (bvand (bvand (ite (= (store (store a0 v2 v5) v0 v3) (store (store a0 v2 v6) v1 v4)) #b1 #b0) (bvand (bvnot (ite (= v0 v1) #b1 #b0)) (bvnot (ite (= v5 v6) #b1 #b0)))) (bvand (bvnot (ite (= v0 v2) #b1 #b0)) (bvnot (ite (= v1 v2) #b1 #b0))))))
(check-sat)
