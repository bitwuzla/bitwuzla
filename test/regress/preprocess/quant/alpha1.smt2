...
; a1 and a2 are alpha equivalent
(assert (and true (forall ((V (_ BitVec 32))) (and (= V (_ bv0 32)) (= (_ bv0 32) (bvadd V (bvmul V V))))))) ; a1
(assert (and true (forall ((x (_ BitVec 32))) (and (= x (_ bv0 32)) (= (_ bv0 32) (bvadd x (bvmul x x))))))) ; a2


; a2, a3, a4 and a5 are alpha equivalent
(assert ; a2
