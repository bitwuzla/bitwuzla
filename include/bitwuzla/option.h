 ...
 */
   ...
   */
#endif
  EVALUE(QUANT_IC_BOUNDS),
  /*!
   * **Quantifiers: IC-based lemma filtering.**
   *
   * When enabled, lemmas generated by the IC-based instantiation strategy
   * are filtered based on expensiveness/usefulness.
   *
   * *Values:*
   *  - **true**: enable
   *  - **false**: disable [**default**]
   ...
   * @warning This is an expert option to configure the quantifier engine.
   */
  EVALUE(QUANT_IC_FILTER),
  /*!
   * **Quantifiers: Under-determined inverse computation for extract/concat.**
   *
   * When enabled, lemmas generated by the IC-based instantiation strategy
   ...
   * @warning This is an expert option to configure the quantifier engine.
   */
  EVALUE(QUANT_IC_UNDERDET),
  /*!
   * **Quantifiers: Value instantiation limit.**
   *
   * Configure `n` for the number of value instantiations to try for a
   * quantified variable before we try to find a symbolic an instantiation
