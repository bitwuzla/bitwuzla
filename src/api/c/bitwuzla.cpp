...
static std::unordered_map<BitwuzlaOption, BzlaOption> bzla_options{
    ...
    {BITWUZLA_OPT_FUN_PREPROPOLD, BZLA_OPT_FUN_PREPROPOLD},
    ...
    {BITWUZLA_OPT_QUANT_EAGER_SKOLEM, BZLA_OPT_QUANT_EAGER_SKOLEM},
    {BITWUZLA_OPT_QUANT_MBQI, BZLA_OPT_QUANT_MBQI},
    {BITWUZLA_OPT_QUANT_MODE, BZLA_OPT_QUANT_MODE},
...
static std::unordered_map<BzlaOption, BitwuzlaOption> bitwuzla_options = {
    ...
    {BZLA_OPT_FUN_PREPROPOLD, BITWUZLA_OPT_FUN_PREPROPOLD},
    ...
    {BZLA_OPT_QUANT_EAGER_SKOLEM, BITWUZLA_OPT_QUANT_EAGER_SKOLEM},
    {BZLA_OPT_QUANT_MBQI, BITWUZLA_OPT_QUANT_MBQI},
    {BZLA_OPT_QUANT_MODE, BITWUZLA_OPT_QUANT_MODE},
...
bitwuzla_simplify(Bitwuzla *bitwuzla)
{
  ...
  BzlaSolverResult bzla_res =
      static_cast<BzlaSolverResult>(bzla_simplify(bzla));
