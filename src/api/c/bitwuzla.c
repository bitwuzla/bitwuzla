...
static BzlaOption bzla_options[BITWUZLA_OPT_NUM_OPTS] = {
    ...
    [BITWUZLA_OPT_PRODUCE_MODELS]          = BZLA_OPT_MODEL_GEN,
    ...
    [BITWUZLA_OPT_REWRITE_LEVEL]           = BZLA_OPT_REWRITE_LEVEL,
    [BITWUZLA_OPT_SKELETON_PREPROC]        = BZLA_OPT_SKELETON_PREPROC,
    [BITWUZLA_OPT_ACKERMANN]               = BZLA_OPT_ACKERMANN,
    [BITWUZLA_OPT_BETA_REDUCE]             = BZLA_OPT_BETA_REDUCE,
    [BITWUZLA_OPT_ELIMINATE_ITES]          = BZLA_OPT_ELIMINATE_ITES,
    [BITWUZLA_OPT_ELIMINATE_SLICES]        = BZLA_OPT_ELIMINATE_SLICES,
    [BITWUZLA_OPT_VAR_SUBST]               = BZLA_OPT_VAR_SUBST,
    [BITWUZLA_OPT_UCOPT]                   = BZLA_OPT_UCOPT,
    [BITWUZLA_OPT_MERGE_LAMBDAS]           = BZLA_OPT_MERGE_LAMBDAS,
    [BITWUZLA_OPT_EXTRACT_LAMBDAS]         = BZLA_OPT_EXTRACT_LAMBDAS,
    [BITWUZLA_OPT_NORMALIZE]               = BZLA_OPT_NORMALIZE,
    [BITWUZLA_OPT_NORMALIZE_ADD]           = BZLA_OPT_NORMALIZE_ADD,
    ...
    [BITWUZLA_OPT_SLS_MOVE_PROP_N_PROP]    = BZLA_OPT_SLS_MOVE_PROP_N_PROP,
    [BITWUZLA_OPT_SLS_MOVE_PROP_N_SLS]     = BZLA_OPT_SLS_MOVE_PROP_N_SLS,
    ...
    [BITWUZLA_OPT_PROP_ASHR]                = BZLA_OPT_PROP_SRA,
    ...
    /* internal options --------------------------------------------------- */
    [BITWUZLA_OPT_SORT_EXP]                = BZLA_OPT_SORT_EXP,
    [BITWUZLA_OPT_SORT_AIG]                = BZLA_OPT_SORT_AIG,
    [BITWUZLA_OPT_SORT_AIGVEC]             = BZLA_OPT_SORT_AIGVEC,
    [BITWUZLA_OPT_SIMPLIFY_CONSTRAINTS]    = BZLA_OPT_SIMPLIFY_CONSTRAINTS,
    [BITWUZLA_OPT_CHECK_UNSAT_ASSUMPTIONS] = BZLA_OPT_CHK_FAILED_ASSUMPTIONS,
    [BITWUZLA_OPT_CHECK_MODEL]             = BZLA_OPT_CHK_MODEL,
    [BITWUZLA_OPT_CHECK_UNCONSTRAINED]     = BZLA_OPT_CHK_UNCONSTRAINED,
    ...
    [BITWUZLA_OPT_SLT_ELIM]                 = BZLA_OPT_SLT_ELIM,
    [BITWUZLA_OPT_SIMP_NORMAMLIZE_ADDERS]   = BZLA_OPT_SIMP_NORMAMLIZE_ADDERS,
    ...
    [BITWUZLA_OPT_RW_ZERO_LOWER_SLICE]      = BZLA_OPT_RW_ZERO_LOWER_SLICE,
    [BITWUZLA_OPT_NONDESTR_SUBST]           = BZLA_OPT_NONDESTR_SUBST,
    [BITWUZLA_OPT_PROP_PROB_FALLBACK_RANDOM_VALUE] =
        BZLA_OPT_PROP_PROB_FALLBACK_RANDOM_VALUE,
    [BITWUZLA_OPT_PRODUCE_UNSAT_CORES] = BZLA_OPT_UNSAT_CORES,
...
static BitwuzlaOption bitwuzla_options[BZLA_OPT_NUM_OPTS] = {
    ...
    [BZLA_OPT_MODEL_GEN]               = BITWUZLA_OPT_PRODUCE_MODELS,
    ...
    [BZLA_OPT_REWRITE_LEVEL]           = BITWUZLA_OPT_REWRITE_LEVEL,
    [BZLA_OPT_SKELETON_PREPROC]        = BITWUZLA_OPT_SKELETON_PREPROC,
    [BZLA_OPT_ACKERMANN]               = BITWUZLA_OPT_ACKERMANN,
    [BZLA_OPT_BETA_REDUCE]             = BITWUZLA_OPT_BETA_REDUCE,
    [BZLA_OPT_ELIMINATE_ITES]          = BITWUZLA_OPT_ELIMINATE_ITES,
    [BZLA_OPT_ELIMINATE_SLICES]        = BITWUZLA_OPT_ELIMINATE_SLICES,
    [BZLA_OPT_VAR_SUBST]               = BITWUZLA_OPT_VAR_SUBST,
    [BZLA_OPT_UCOPT]                   = BITWUZLA_OPT_UCOPT,
    [BZLA_OPT_MERGE_LAMBDAS]           = BITWUZLA_OPT_MERGE_LAMBDAS,
    [BZLA_OPT_EXTRACT_LAMBDAS]         = BITWUZLA_OPT_EXTRACT_LAMBDAS,
    [BZLA_OPT_NORMALIZE]               = BITWUZLA_OPT_NORMALIZE,
    [BZLA_OPT_NORMALIZE_ADD]           = BITWUZLA_OPT_NORMALIZE_ADD,
    ...
    [BZLA_OPT_SLS_MOVE_PROP_N_PROP]    = BITWUZLA_OPT_SLS_MOVE_PROP_N_PROP,
    [BZLA_OPT_SLS_MOVE_PROP_N_SLS]     = BITWUZLA_OPT_SLS_MOVE_PROP_N_SLS,
    ...
    [BZLA_OPT_PROP_SRA]                 = BITWUZLA_OPT_PROP_ASHR,
    ...
    /* internal options --------------------------------------------------- */
    [BZLA_OPT_SORT_EXP]               = BITWUZLA_OPT_SORT_EXP,
    [BZLA_OPT_SORT_AIG]               = BITWUZLA_OPT_SORT_AIG,
    [BZLA_OPT_SORT_AIGVEC]            = BITWUZLA_OPT_SORT_AIGVEC,
    [BZLA_OPT_SIMPLIFY_CONSTRAINTS]   = BITWUZLA_OPT_SIMPLIFY_CONSTRAINTS,
    [BZLA_OPT_CHK_FAILED_ASSUMPTIONS] = BITWUZLA_OPT_CHECK_UNSAT_ASSUMPTIONS,
    [BZLA_OPT_CHK_MODEL]              = BITWUZLA_OPT_CHECK_MODEL,
    [BZLA_OPT_CHK_UNCONSTRAINED]      = BITWUZLA_OPT_CHECK_UNCONSTRAINED,
    ...
    [BZLA_OPT_SLT_ELIM]                 = BITWUZLA_OPT_SLT_ELIM,
    [BZLA_OPT_SIMP_NORMAMLIZE_ADDERS]   = BITWUZLA_OPT_SIMP_NORMAMLIZE_ADDERS,
    ...
    [BZLA_OPT_RW_ZERO_LOWER_SLICE]      = BITWUZLA_OPT_RW_ZERO_LOWER_SLICE,
    [BZLA_OPT_NONDESTR_SUBST]           = BITWUZLA_OPT_NONDESTR_SUBST,
    [BZLA_OPT_PROP_PROB_FALLBACK_RANDOM_VALUE] =
        BITWUZLA_OPT_PROP_PROB_FALLBACK_RANDOM_VALUE,
    [BZLA_OPT_UNSAT_CORES]   = BITWUZLA_OPT_PRODUCE_UNSAT_CORES,
