...
const std::unordered_map<Option, bzla::option::Option> s_internal_options = {
    ...
    {Option::PP_UNCONSTRAINED_OPTIMIZATION, bzla::option::Option::NUM_OPTIONS},
    {Option::PP_VAR_SUBST, bzla::option::Option::NUM_OPTIONS},
    {Option::RW_EXTRACT_ARITH, bzla::option::Option::NUM_OPTIONS},
    {Option::RW_LEVEL, bzla::option::Option::NUM_OPTIONS},
    {Option::RW_NORMALIZE, bzla::option::Option::NUM_OPTIONS},
    {Option::RW_NORMALIZE_ADD, bzla::option::Option::NUM_OPTIONS},
    {Option::RW_SIMPLIFY_CONSTRAINTS, bzla::option::Option::NUM_OPTIONS},
    {Option::RW_SLT, bzla::option::Option::NUM_OPTIONS},
    {Option::RW_SORT_AIG, bzla::option::Option::NUM_OPTIONS},
    {Option::RW_SORT_AIGVEC, bzla::option::Option::NUM_OPTIONS},
    {Option::RW_SORT_EXP, bzla::option::Option::NUM_OPTIONS},
    {Option::FUN_DUAL_PROP, bzla::option::Option::NUM_OPTIONS},
    {Option::FUN_DUAL_PROP_QSORT, bzla::option::Option::NUM_OPTIONS},
    {Option::FUN_EAGER_LEMMAS, bzla::option::Option::NUM_OPTIONS},
    {Option::FUN_LAZY_SYNTHESIZE, bzla::option::Option::NUM_OPTIONS},
    {Option::FUN_JUST, bzla::option::Option::NUM_OPTIONS},
    {Option::FUN_JUST_HEURISTIC, bzla::option::Option::NUM_OPTIONS},
    {Option::FUN_PREPROP, bzla::option::Option::NUM_OPTIONS},
    {Option::FUN_PREPROPOLD, bzla::option::Option::NUM_OPTIONS},
    {Option::FUN_PRESLS, bzla::option::Option::NUM_OPTIONS},
    {Option::FUN_STORE_LAMBDAS, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_JUST, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_MOVE_GW, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_MOVE_INC_MOVE_TEST, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_MOVE_PROP, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_MOVE_PROP_FORCE_RW, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_MOVE_PROP_NPROPS, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_MOVE_PROP_NSLSS, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_MOVE_RAND_ALL, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_MOVE_RAND_RANGE, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_MOVE_RAND_WALK, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_MOVE_RANGE, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_MOVE_SEGMENT, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_PROB_MOVE_RAND_WALK, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_NFLIPS, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_STRATEGY, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_USE_RESTARTS, bzla::option::Option::NUM_OPTIONS},
    {Option::SLS_USE_BANDIT, bzla::option::Option::NUM_OPTIONS},
    {Option::PROP_ASHR, bzla::option::Option::NUM_OPTIONS},
    ...
    {Option::PROP_FLIP_COND_CONST_NPATHSEL, bzla::option::Option::NUM_OPTIONS},
