...
static const std::unordered_map<Option, bzla::option::Option>
    s_internal_options = {
        ...
        {Option::QUANT_IC_UNDERDET, bzla::option::Option::QUANT_IC_UNDERDET},
        ...
        {Option::PP_QUANT, bzla::option::Option::PP_QUANT},
        {Option::PP_QUANT_ALPHA, bzla::option::Option::PP_QUANT_ALPHA},
