...
static const std::unordered_map<Option, bzla::option::Option>
    s_internal_options = {
        ...
        {Option::MALLOB_API_DIR, bzla::option::Option::MALLOB_API_DIR},
        {Option::MALLOB_BINARY, bzla::option::Option::MALLOB_BINARY},
        {Option::MALLOB_LAUNCHER, bzla::option::Option::MALLOB_LAUNCHER},
        {Option::MALLOB_ARGS, bzla::option::Option::MALLOB_ARGS},
