...
BoolectorNode *
boolector_not(Bzla *bzla, BoolectorNode *node)
{
  BzlaNode *exp, *res;
  ...
  BZLA_TRAPI_RETURN_NODE(res);
#ifndef NDEBUG
  BZLA_CHKCLONE_RES_PTR(res, not, BZLA_CLONED_EXP(exp));
#endif
  return BZLA_EXPORT_BOOLECTOR_NODE(res);
}

BoolectorNode *
boolector_neg(Bzla *bzla, BoolectorNode *node)
{
  BzlaNode *exp, *res;
  ...
  BZLA_TRAPI_RETURN_NODE(res);
#ifndef NDEBUG
  BZLA_CHKCLONE_RES_PTR(res, neg, BZLA_CLONED_EXP(exp));
#endif
  return BZLA_EXPORT_BOOLECTOR_NODE(res);
}

BoolectorNode *
boolector_redor(Bzla *bzla, BoolectorNode *node)
{
  BzlaNode *exp, *res;
  ...
  BZLA_TRAPI_RETURN_NODE(res);
#ifndef NDEBUG
  BZLA_CHKCLONE_RES_PTR(res, redor, BZLA_CLONED_EXP(exp));
#endif
  return BZLA_EXPORT_BOOLECTOR_NODE(res);
}

BoolectorNode *
boolector_redxor(Bzla *bzla, BoolectorNode *node)
{
  BzlaNode *exp, *res;
  ...
  BZLA_TRAPI_RETURN_NODE(res);
#ifndef NDEBUG
  BZLA_CHKCLONE_RES_PTR(res, redxor, BZLA_CLONED_EXP(exp));
#endif
  return BZLA_EXPORT_BOOLECTOR_NODE(res);
}

BoolectorNode *
boolector_redand(Bzla *bzla, BoolectorNode *node)
{
  BzlaNode *exp, *res;
  ...
  BZLA_TRAPI_RETURN_NODE(res);
#ifndef NDEBUG
  BZLA_CHKCLONE_RES_PTR(res, redand, BZLA_CLONED_EXP(exp));
#endif
  return BZLA_EXPORT_BOOLECTOR_NODE(res);
}

BoolectorNode *
boolector_slice(Bzla *bzla, BoolectorNode *node, uint32_t upper, uint32_t lower)
{
  BzlaNode *exp, *res;
  ...
  BZLA_TRAPI_RETURN_NODE(res);
#ifndef NDEBUG
  BZLA_CHKCLONE_RES_PTR(res, slice, BZLA_CLONED_EXP(exp), upper, lower);
#endif
  return BZLA_EXPORT_BOOLECTOR_NODE(res);
}

BoolectorNode *
boolector_uext(Bzla *bzla, BoolectorNode *node, uint32_t width)
{
  BzlaNode *exp, *res;
  ...
  BZLA_TRAPI_RETURN_NODE(res);
#ifndef NDEBUG
  BZLA_CHKCLONE_RES_PTR(res, uext, BZLA_CLONED_EXP(exp), width);
#endif
  return BZLA_EXPORT_BOOLECTOR_NODE(res);
}

BoolectorNode *
boolector_sext(Bzla *bzla, BoolectorNode *node, uint32_t width)
{
  BzlaNode *exp, *res;
  ...
  BZLA_TRAPI_RETURN_NODE(res);
#ifndef NDEBUG
  BZLA_CHKCLONE_RES_PTR(res, sext, BZLA_CLONED_EXP(exp), width);
#endif
  return BZLA_EXPORT_BOOLECTOR_NODE(res);
}

BoolectorNode *
boolector_xor(Bzla *bzla, BoolectorNode *n0, BoolectorNode *n1)
{
  BzlaNode *e0, *e1, *res;
  ...
  BZLA_TRAPI_RETURN_NODE(res);
#ifndef NDEBUG
  BZLA_CHKCLONE_RES_PTR(res, xor, BZLA_CLONED_EXP(e0), BZLA_CLONED_EXP(e1));
#endif
  return BZLA_EXPORT_BOOLECTOR_NODE(res);
}
