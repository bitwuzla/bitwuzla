  ...
  */
  ...
  /*!
    * **BZLA_OPT_INPUT_FORMAT**
      ...
      | If unspecified, Bitwuzla automatically detects the input file format
        while parsing.
  ...
  */
  ...
  /*!
    * **BZLA_OPT_EXIT_CODES**
      ...
      | Enable (``value``:1) or disable (``value``:0) the use of Bitwuzla exit
        codes (BITWUZLA_SAT, BITWUZLA_UNSAT, BITWUZLA_UNKNOWN - see
        :ref:`macros`).
      | If disabled, on exit Bitwuzla returns 0 if success (sat or unsat), and
        1 in any other case.
  */
  BZLA_OPT_EXIT_CODES,
  ...
  /*!
    * **BZLA_OPT_SEED**
      ...
      | Set seed for Bitwuzla's internal random number generator.
      | Bitwuzla uses 0 by default.
  */
  BZLA_OPT_SEED,
  ...
  */
  ...
  /*!
    * **BZLA_OPT_PRINT_DIMACS**
      ...
      When enabled Bitwuzla will record the CNF sent to the SAT solver and
      prints it to stdout.
   */
  BZLA_OPT_PRINT_DIMACS,
