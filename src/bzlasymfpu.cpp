...
bool
BzlaFPSymProp::checkNode(const BzlaNode *node)
{
...
template <bool is_signed>
bool
BzlaFPSymBV<is_signed>::checkNode(const BzlaNode *node)
{
  return bzla_sort_is_bv(node->bzla, bzla_node_get_sort_id(node));
}
