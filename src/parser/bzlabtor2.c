                   ...
                   BzlaParseResult *res)
{
  ...
  while ((line = btor2parser_iter_next(&lit)))
  {
    ...
    switch (line->tag)
    {
      case BTOR2_TAG_add:
        assert(line->nargs == 2);
        node = boolector_add(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_and:
        assert(line->nargs == 2);
        node = boolector_and(bzla, e[0], e[1]);
        break;
      ...
      case BTOR2_TAG_mul:
        assert(line->nargs == 2);
        node = boolector_mul(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_nand:
        assert(line->nargs == 2);
        node = boolector_nand(bzla, e[0], e[1]);
        break;
      ...
      case BTOR2_TAG_neg:
        assert(line->nargs == 1);
        node = boolector_neg(bzla, e[0]);
        break;

      case BTOR2_TAG_nor:
        assert(line->nargs == 2);
        node = boolector_nor(bzla, e[0], e[1]);
        break;
      ...
      case BTOR2_TAG_or:
        assert(line->nargs == 2);
        node = boolector_or(bzla, e[0], e[1]);
        break;
      ...
      case BTOR2_TAG_redand:
        assert(line->nargs == 1);
        node = boolector_redand(bzla, e[0]);
        break;

      case BTOR2_TAG_redor:
        assert(line->nargs == 1);
        node = boolector_redor(bzla, e[0]);
        break;
      ...
      case BTOR2_TAG_rol:
        assert(line->nargs == 2);
        node = boolector_rol(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_ror:
        assert(line->nargs == 2);
        node = boolector_ror(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_saddo:
        assert(line->nargs == 2);
        node = boolector_saddo(bzla, e[0], e[1]);
        break;
      ...
      case BTOR2_TAG_sgte:
        assert(line->nargs == 2);
        node = boolector_sgte(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_slice:
        assert(line->nargs == 1);
        node = boolector_slice(bzla, e[0], line->args[1], line->args[2]);
        break;

      case BTOR2_TAG_sll:
        assert(line->nargs == 2);
        node = boolector_sll(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_slt:
        assert(line->nargs == 2);
        node = boolector_slt(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_slte:
        assert(line->nargs == 2);
        node = boolector_slte(bzla, e[0], e[1]);
        break;
      ...
      case BTOR2_TAG_smulo:
        assert(line->nargs == 2);
        node = boolector_smulo(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_sra:
        assert(line->nargs == 2);
        node = boolector_sra(bzla, e[0], e[1]);
        break;
      ...
      case BTOR2_TAG_srl:
        assert(line->nargs == 2);
        node = boolector_srl(bzla, e[0], e[1]);
        break;
      ...
      case BTOR2_TAG_sub:
        assert(line->nargs == 2);
        node = boolector_sub(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_uaddo:
        assert(line->nargs == 2);
        node = boolector_uaddo(bzla, e[0], e[1]);
        break;
      ...
      case BTOR2_TAG_ugt:
        assert(line->nargs == 2);
        node = boolector_ugt(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_ugte:
        assert(line->nargs == 2);
        node = boolector_ugte(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_ult:
        assert(line->nargs == 2);
        node = boolector_ult(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_ulte:
        assert(line->nargs == 2);
        node = boolector_ulte(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_umulo:
        assert(line->nargs == 2);
        node = boolector_umulo(bzla, e[0], e[1]);
        break;
      ...
      case BTOR2_TAG_usubo:
        assert(line->nargs == 2);
        node = boolector_usubo(bzla, e[0], e[1]);
        break;
      ...
      case BTOR2_TAG_xnor:
        assert(line->nargs == 2);
        node = boolector_xnor(bzla, e[0], e[1]);
        break;

      case BTOR2_TAG_xor:
        assert(line->nargs == 2);
        node = boolector_xor(bzla, e[0], e[1]);
        break;
