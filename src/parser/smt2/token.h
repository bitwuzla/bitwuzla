...
enum class Token
{
  ...
  BV_VALUE        = 1 + static_cast<int32_t>(TokenClass::BV),
  BV_ADD          = 2 + static_cast<int32_t>(TokenClass::BV),
  BV_AND          = 3 + static_cast<int32_t>(TokenClass::BV),
  BV_ASHR         = 4 + static_cast<int32_t>(TokenClass::BV),
  BV_COMP         = 5 + static_cast<int32_t>(TokenClass::BV),
  BV_CONCAT       = 6 + static_cast<int32_t>(TokenClass::BV),
  BV_EXTRACT      = 7 + static_cast<int32_t>(TokenClass::BV),
  BV_LSHR         = 8 + static_cast<int32_t>(TokenClass::BV),
  BV_MUL          = 9 + static_cast<int32_t>(TokenClass::BV),
  BV_NAND         = 10 + static_cast<int32_t>(TokenClass::BV),
  BV_NEG          = 11 + static_cast<int32_t>(TokenClass::BV),
  BV_NOR          = 12 + static_cast<int32_t>(TokenClass::BV),
  BV_NOT          = 13 + static_cast<int32_t>(TokenClass::BV),
  BV_OR           = 14 + static_cast<int32_t>(TokenClass::BV),
  BV_REPEAT       = 15 + static_cast<int32_t>(TokenClass::BV),
  BV_ROTATE_LEFT  = 16 + static_cast<int32_t>(TokenClass::BV),
  BV_ROTATE_RIGHT = 17 + static_cast<int32_t>(TokenClass::BV),
  BV_SDIV         = 18 + static_cast<int32_t>(TokenClass::BV),
  BV_SGE          = 19 + static_cast<int32_t>(TokenClass::BV),
  BV_SGT          = 20 + static_cast<int32_t>(TokenClass::BV),
  BV_SHL          = 21 + static_cast<int32_t>(TokenClass::BV),
  BV_SIGN_EXTEND  = 22 + static_cast<int32_t>(TokenClass::BV),
  BV_SLE          = 23 + static_cast<int32_t>(TokenClass::BV),
  BV_SLT          = 24 + static_cast<int32_t>(TokenClass::BV),
  BV_SMOD         = 25 + static_cast<int32_t>(TokenClass::BV),
  BV_SREM         = 26 + static_cast<int32_t>(TokenClass::BV),
  BV_SUB          = 27 + static_cast<int32_t>(TokenClass::BV),
  BV_UDIV         = 28 + static_cast<int32_t>(TokenClass::BV),
  BV_UGE          = 29 + static_cast<int32_t>(TokenClass::BV),
  BV_UGT          = 30 + static_cast<int32_t>(TokenClass::BV),
  BV_ULE          = 31 + static_cast<int32_t>(TokenClass::BV),
  BV_ULT          = 32 + static_cast<int32_t>(TokenClass::BV),
  BV_UREM         = 33 + static_cast<int32_t>(TokenClass::BV),
  BV_XNOR         = 34 + static_cast<int32_t>(TokenClass::BV),
  BV_XOR          = 35 + static_cast<int32_t>(TokenClass::BV),
  BV_ZERO_EXTEND  = 36 + static_cast<int32_t>(TokenClass::BV),
  // Bitwuzla extensions
  BV_REDOR  = 37 + static_cast<int32_t>(TokenClass::BV),
  BV_REDAND = 38 + static_cast<int32_t>(TokenClass::BV),
  BV_REDXOR = 39 + static_cast<int32_t>(TokenClass::BV),
  BV_SADDO  = 40 + static_cast<int32_t>(TokenClass::BV),
  BV_UADDO  = 41 + static_cast<int32_t>(TokenClass::BV),
  BV_SDIVO  = 42 + static_cast<int32_t>(TokenClass::BV),
  BV_SMULO  = 43 + static_cast<int32_t>(TokenClass::BV),
  BV_UMULO  = 44 + static_cast<int32_t>(TokenClass::BV),
  BV_SSUBO  = 45 + static_cast<int32_t>(TokenClass::BV),
  BV_USUBO  = 46 + static_cast<int32_t>(TokenClass::BV),
