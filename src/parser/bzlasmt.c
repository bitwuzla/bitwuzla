    ...
    if (isleaf(child))
    {
      ...
      switch (symbol->token)
      {
        ...
        case BZLA_SMTOK_BVADD:
          translate_associative_binary(parser, node, "bvadd", boolector_bv_add);
          break;
        case BZLA_SMTOK_BVSUB:
          translate_binary(parser, node, "bvsub", boolector_bv_sub);
          break;
        case BZLA_SMTOK_BVSDIV:
          translate_binary(parser, node, "bvsdiv", boolector_bv_sdiv);
          break;
        case BZLA_SMTOK_BVUDIV:
          translate_binary(parser, node, "bvudiv", boolector_bv_udiv);
          break;
        case BZLA_SMTOK_BVUREM:
          translate_binary(parser, node, "bvurem", boolector_bv_urem);
          break;
        ...
        case BZLA_SMTOK_BVULE:
          translate_binary(parser, node, "bvule", boolector_bv_ulte);
          break;
        case BZLA_SMTOK_BVSLE:
          translate_binary(parser, node, "bvsle", boolector_bv_slte);
          break;
        case BZLA_SMTOK_BVSGT:
          translate_binary(parser, node, "bvsgt", boolector_bv_sgt);
          break;
        case BZLA_SMTOK_BVSGE:
          translate_binary(parser, node, "bvsge", boolector_bv_sgte);
          break;
        case BZLA_SMTOK_BVCOMP:
          translate_binary(parser, node, "bvcomp", boolector_eq);
          break;
        case BZLA_SMTOK_BVULT:
          translate_binary(parser, node, "bvult", boolector_bv_ult);
          break;
        case BZLA_SMTOK_BVUGT:
          translate_binary(parser, node, "bvugt", boolector_bv_ugt);
          break;
        case BZLA_SMTOK_BVUGE:
          translate_binary(parser, node, "bvuge", boolector_bv_ugte);
          break;
        case BZLA_SMTOK_BVSLT:
          translate_binary(parser, node, "bvslt", boolector_bv_slt);
          break;
        ...
        case BZLA_SMTOK_BVNOR:
          translate_binary(parser, node, "bvnor", boolector_bv_nor);
          break;
