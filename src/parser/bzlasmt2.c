...
typedef enum BzlaSMT2Tag
{
  ...
  BZLA_LOGIC_QF_UFIDL_TAG_SMT2  = 20 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFLIA_TAG_SMT2  = 21 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFLRA_TAG_SMT2  = 22 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFNRA_TAG_SMT2  = 23 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_UFLRA_TAG_SMT2     = 24 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_UFNIA_TAG_SMT2     = 25 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_BV_TAG_SMT2        = 26 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_UFBV_TAG_SMT2      = 27 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_ABV_TAG_SMT2       = 28 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_ALL_TAG_SMT2       = 29 + BZLA_LOGIC_TAG_CLASS_SMT2,
