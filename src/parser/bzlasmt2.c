...
typedef enum BzlaSMT2Tag
{
  ...
  BZLA_LOGIC_QF_IDL_TAG_SMT2    = 9 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_LIA_TAG_SMT2    = 10 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_LRA_TAG_SMT2    = 11 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_NIA_TAG_SMT2    = 12 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_NRA_TAG_SMT2    = 13 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_RDL_TAG_SMT2    = 14 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UF_TAG_SMT2     = 15 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFBV_TAG_SMT2   = 16 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFIDL_TAG_SMT2  = 17 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFLIA_TAG_SMT2  = 18 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFLRA_TAG_SMT2  = 19 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFNRA_TAG_SMT2  = 20 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_UFLRA_TAG_SMT2     = 21 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_UFNIA_TAG_SMT2     = 22 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_BV_TAG_SMT2        = 23 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_UFBV_TAG_SMT2      = 24 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_ABV_TAG_SMT2       = 25 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_ALL_TAG_SMT2       = 26 + BZLA_LOGIC_TAG_CLASS_SMT2,
