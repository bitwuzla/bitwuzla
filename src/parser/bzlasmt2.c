...
typedef enum BzlaSMT2Tag
{
  ...
  BZLA_LOGIC_QF_AUFBV_TAG_SMT2  = 6 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_AUFLIA_TAG_SMT2 = 7 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_AX_TAG_SMT2     = 8 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_BV_TAG_SMT2     = 9 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_BVFP_TAG_SMT2   = 10 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_FP_TAG_SMT2     = 11 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_IDL_TAG_SMT2    = 12 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_LIA_TAG_SMT2    = 13 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_LRA_TAG_SMT2    = 14 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_NIA_TAG_SMT2    = 15 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_NRA_TAG_SMT2    = 16 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_RDL_TAG_SMT2    = 17 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UF_TAG_SMT2     = 18 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFBV_TAG_SMT2   = 19 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFFP_TAG_SMT2   = 20 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFIDL_TAG_SMT2  = 21 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFLIA_TAG_SMT2  = 22 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFLRA_TAG_SMT2  = 23 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_QF_UFNRA_TAG_SMT2  = 24 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_UFLRA_TAG_SMT2     = 25 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_UFNIA_TAG_SMT2     = 26 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_BV_TAG_SMT2        = 27 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_UFBV_TAG_SMT2      = 28 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_ABV_TAG_SMT2       = 29 + BZLA_LOGIC_TAG_CLASS_SMT2,
  BZLA_LOGIC_ALL_TAG_SMT2       = 30 + BZLA_LOGIC_TAG_CLASS_SMT2,
                                               ...
                                               BoolectorNode *) )
{
  ...
  exp = fun(parser->bzla, item_cur[1].exp, item_cur[2].exp, item_cur[3].exp);
  release_exp_and_overwrite(parser, item_open, item_cur, nargs, exp);
  return 1;
}
...
close_term(BzlaSMT2Parser *parser)
{
  ...
  else if (tag == BZLA_BV_CONCAT_TAG_SMT2)
  {
    if (!close_term_bin_bv_left_associative(
            parser, item_open, item_cur, nargs, boolector_bv_concat))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_left_associative(
            parser, item_open, item_cur, nargs, boolector_bv_add))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_left_associative(
            parser, item_open, item_cur, nargs, boolector_bv_sub))
    {
      return 0;
    }
  }
  ...
  else if (tag == BZLA_BV_UDIV_TAG_SMT2)
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_udiv))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_sll))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_srl))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_ult))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_nand))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_nor))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_srem))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_smod))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_sra))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_ulte))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_ugt))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_ugte))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_slt))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_slte))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_sgt))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_bv_fun(
            parser, item_open, item_cur, nargs, boolector_bv_sgte))
    {
      return 0;
    }
  }
  ...
  else if (tag == BZLA_FP_ADD_TAG_SMT2)
  {
    if (!close_term_bin_rm_fp_fun(
            parser, item_open, item_cur, nargs, boolector_fp_add))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_rm_fp_fun(
            parser, item_open, item_cur, nargs, boolector_fp_sub))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_rm_fp_fun(
            parser, item_open, item_cur, nargs, boolector_fp_mul))
    {
      return 0;
    }
  }
  ...
  {
    if (!close_term_bin_rm_fp_fun(
            parser, item_open, item_cur, nargs, boolector_fp_div))
    {
      return 0;
    }
  }
