                                     ...
                                     const Node& t) const
{
  ...
  Node zero       = d_nm.mk_value(BitVector::mk_zero(size));
...
{
  size_t size     = x.type().bv_size();
  Node one        = d_nm.mk_value(BitVector::mk_one(size));
  return d_nm.mk_node(
      Kind::IMPLIES,
                                    ...
                                    const Node& t) const
{
  ...
  return d_nm.mk_node(
      ...
      {d_nm.mk_node(Kind::EQUAL, {s, ones}),
       d_nm.mk_node(Kind::EQUAL, {t, d_nm.mk_node(Kind::BV_NEG, {x})})});
}
  ...
  return d_nm.mk_node(
      ...
      {one,
       d_nm.mk_node(Kind::BV_NOT,
                    {d_nm.mk_node(Kind::BV_AND,
                                  {x, d_nm.mk_node(Kind::BV_AND, {s, t})})})});
}
      ...
      {t,
       d_nm.mk_node(
           ...
           {d_nm.mk_node(
               ...
               {t,
                d_nm.mk_node(Kind::BV_OR,
                             {one, d_nm.mk_node(Kind::BV_AND, {x, s})})})})});
}
                                     ...
                                     const Node& t) const
{
  ...
  return d_nm.mk_node(
      Kind::BV_UGE,
      {s,
       d_nm.mk_node(Kind::BV_SHL, {d_nm.mk_node(Kind::BV_SHR, {t, x}), one})});
}
  ...
  return d_nm.mk_node(
      ...
      {x,
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(Kind::BV_AND,
                         {s, d_nm.mk_node(Kind::BV_SHR, {one, t})})})});
}
  ...
  return d_nm.mk_node(
      ...
      {x,
       d_nm.mk_node(Kind::BV_SHL,
                    {one,
                     d_nm.mk_node(Kind::BV_SHL,
                                  {x, d_nm.mk_node(Kind::BV_SHR, {s, t})})})});
}
  ...
  return d_nm.mk_node(
      ...
      {x,
       d_nm.mk_node(Kind::BV_ADD,
                    {one,
                     d_nm.mk_node(Kind::BV_SHL,
                                  {x, d_nm.mk_node(Kind::BV_SUB, {t, s})})})});
}
...
namespace {
Node
mul_noovfl_condition(NodeManager& nm,
                     const Node& val_x,
                     const Node& val_s,
                     const Node& x,
                     const Node& s)
...
Node
mul_ovfl_condition(NodeManager& nm,
                   const Node& val_x,
                   const Node& val_s,
                   const Node& x,
                   const Node& s)
                                        ...
                                        const Node& t) const
{
  ...
  Node noovfl = mul_noovfl_condition(d_nm, val_x, val_s, x, s);
  if (noovfl.is_null())
  {
    return Node();
  }
                                        ...
                                        const Node& t) const
{
  ...
  return d_nm.mk_node(
      ...
      {noovfl,
       d_nm.mk_node(
           Kind::BV_UGE,
           {d_nm.mk_node(Kind::BV_OR, {one, d_nm.mk_node(Kind::BV_NOT, {x})}),
            s})});
}
       ...
       d_nm.mk_node(
           ...
           {t,
            d_nm.mk_node(
                ...
                {t,
                 d_nm.mk_node(Kind::BV_AND,
                              {x, d_nm.mk_node(Kind::BV_AND, {s, one})})})})});
}
            ...
            d_nm.mk_node(
                ...
                {x,
                 d_nm.mk_node(
                     ...
                     {d_nm.mk_node(
                         Kind::BV_OR,
                         {t, d_nm.mk_node(Kind::BV_AND, {s, one})})})})})});
}
                                             ...
                                             const Node& t) const
{
  ...
  return d_nm.mk_node(
      ...
      {noovfl,
       d_nm.mk_node(
           Kind::BV_UGE,
           {d_nm.mk_node(Kind::BV_AND, {t, d_nm.mk_node(Kind::BV_NEG, {x})}),
            d_nm.mk_node(Kind::BV_AND, {x, s})})});
}
            ...
            d_nm.mk_node(
                ...
                {s,
                 d_nm.mk_node(
                     ...
                     {d_nm.mk_node(
                         Kind::BV_OR,
                         {x, d_nm.mk_node(Kind::BV_OR, {t, one})})})})})});
}
            ...
            d_nm.mk_node(
                ...
                {s,
                 d_nm.mk_node(
                     ...
                     {d_nm.mk_node(
                         Kind::BV_OR,
                         {t, d_nm.mk_node(Kind::BV_AND, {x, one})})})})})});
}
  ...
  return d_nm.mk_node(
      ...
      {noovfl,
       d_nm.mk_node(
           ...
           {t,
            d_nm.mk_node(Kind::BV_OR,
                         {one, d_nm.mk_node(Kind::BV_ADD, {x, s})})})});
}
       ...
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(
                Kind::BV_SHR,
                {d_nm.mk_node(Kind::BV_SUB,
                              {d_nm.mk_node(Kind::BV_SHR, {x, s}), one}),
                 one})})});
}
                                          ...
                                          const Node& t) const
{
  ...
  Node ovfl = mul_ovfl_condition(d_nm, val_x, val_s, x, s);
  if (ovfl.is_null())
  {
    return Node();
  }
       ...
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(
                ...
                {s,
                 d_nm.mk_node(Kind::BV_OR,
                              {one, d_nm.mk_node(Kind::BV_AND, {x, t})})})})});
}
  ...
  return d_nm.mk_node(
      ...
      {ovfl,
       d_nm.mk_node(Kind::DISTINCT,
                    {one,
                     d_nm.mk_node(Kind::BV_AND,
                                  {s, d_nm.mk_node(Kind::BV_XOR, {x, t})})})});
}
       ...
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(
                ...
                {t,
                 d_nm.mk_node(Kind::BV_AND,
                              {one, d_nm.mk_node(Kind::BV_XOR, {x, s})})})})});
}
  ...
  return d_nm.mk_node(
      ...
      {ovfl,
       d_nm.mk_node(
           ...
           {t,
            d_nm.mk_node(Kind::BV_SHL,
                         {s, d_nm.mk_node(Kind::BV_AND, {x, one})})})});
}
  ...
  return d_nm.mk_node(
      ...
      {ovfl,
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(Kind::BV_OR,
                         {x, d_nm.mk_node(Kind::BV_AND, {t, one})})})});
}
       ...
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(
                Kind::BV_NEG,
                {d_nm.mk_node(Kind::BV_AND,
                              {s, d_nm.mk_node(Kind::BV_XOR, {t, one})})})})});
}
       ...
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(
                ...
                {s,
                 d_nm.mk_node(Kind::BV_OR,
                              {t, d_nm.mk_node(Kind::BV_XOR, {s, one})})})})});
}
  ...
  return d_nm.mk_node(
      ...
      {ovfl,
       d_nm.mk_node(
           Kind::DISTINCT,
           {t,
            d_nm.mk_node(Kind::BV_OR, {s, d_nm.mk_node(Kind::BV_NEG, {x})})})});
}
  ...
  return d_nm.mk_node(
      ...
      {ovfl,
       d_nm.mk_node(
           Kind::DISTINCT,
           {t,
            d_nm.mk_node(Kind::BV_OR, {x, d_nm.mk_node(Kind::BV_NEG, {s})})})});
}
       ...
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(
                ...
                {s,
                 d_nm.mk_node(Kind::BV_XOR,
                              {one, d_nm.mk_node(Kind::BV_NEG, {t})})})})});
}
       ...
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(
                ...
                {t,
                 d_nm.mk_node(Kind::BV_XOR,
                              {x, d_nm.mk_node(Kind::BV_OR, {s, one})})})})});
}
       ...
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(
                ...
                {s,
                 d_nm.mk_node(Kind::BV_OR,
                              {t, d_nm.mk_node(Kind::BV_XOR, {x, one})})})})});
}
       ...
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(
                ...
                {x,
                 d_nm.mk_node(Kind::BV_OR,
                              {one, d_nm.mk_node(Kind::BV_AND, {s, t})})})})});
}
  ...
  return d_nm.mk_node(
      ...
      {x,
       d_nm.mk_node(
           ...
           {x,
            d_nm.mk_node(Kind::BV_SHR,
                         {t, d_nm.mk_node(Kind::BV_SHL, {t, one})})})});
}
  ...
  return d_nm.mk_node(
      ...
      {x,
       d_nm.mk_node(Kind::BV_SUB,
                    {one,
                     d_nm.mk_node(Kind::BV_SHL,
                                  {x, d_nm.mk_node(Kind::BV_ADD, {x, t})})})});
}
