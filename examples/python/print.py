...
if __name__ == "__main__":
    ...
    print('Print value of fp const (base ignored):')
    print('---------------------------------------')
    assert fp_val.value() == fp_val.value(10)
    assert fp_val.value() == fp_val.value(16)
    print(f'{fp}: {fp_val.value():>16} [str] (bin)')
    print(f'{fp}: {fp_val.value(10):>16} [str] (dec [ignored])')
    print(f'{fp}: {fp_val.value(16):>16} [str] (hex [ignored])')
    print()
